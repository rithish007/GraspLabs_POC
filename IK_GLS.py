...
SB = 174/1000    # base side length
SP = 87/1000    # platform side length
L  = 170/1000    # driver link length
l  = 335/1000    # driven link length (GIVEN ACCORDING TO THE 3D MODEL)
delta = 78/1000  # distance between the each pair of driven links
...
#Refer page:6
Sb=174
print("Base equilateral triangle side: ",Sb)

Sp=87
print("Platform equilateral triangle side: " ,Sp)

L=170
print("Upper legs length: ",L)

l=335
print("Lower legs parallelogram length: ",l)
########################################################################################################################
